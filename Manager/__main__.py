...
My owner is [𝙃𝙀𝙇𝙇𝘽𝙊𝙄_𝘼𝙏𝙐𝙇](t.me/HELLOBOI_ATUL31)
...
DONATE_STRING = """Heya, glad to hear you want to donate! I'm not accepting any donations right now, still, if needed, give a thanks to @sipak_op."""
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1303895686 and DONATION_LINK:
